...
class AdminController
{
    ...
    private function mechanicData(Request $request, bool $create): array
    {
        ...
        $d = $request->validate(['nameEn' => [$r, 'string', 'max:160'], 'nameAr' => [$r, 'string', 'max:160'], 'descriptionEn' => ['nullable', 'string', 'max:2000'], 'descriptionAr' => ['nullable', 'string', 'max:2000'], 'phone' => ['nullable', 'string', 'max:32'], 'email' => ['nullable', 'email:rfc'], 'address' => [$r, 'string', 'max:255'], 'city' => [$r, 'string', 'max:120'], 'countryCode' => [$r, 'string', 'size:2'], 'timezone' => ['sometimes', 'timezone:all'], 'latitude' => [$r, 'numeric', 'between:-90,90'], 'longitude' => [$r, 'numeric', 'between:-180,180'], 'workingHours' => ['nullable', 'array'], 'workingHours.*' => ['array', 'size:2'], 'workingHours.*.*' => ['date_format:H:i'], 'specialtyCodes' => ['sometimes', 'array', 'max:20'], 'specialtyCodes.*' => ['string', 'distinct', 'exists:mechanic_specialties,code'], 'active' => ['sometimes', 'boolean']]);
        $map = ['nameEn' => 'name_en', 'nameAr' => 'name_ar', 'descriptionEn' => 'description_en', 'descriptionAr' => 'description_ar', 'phone' => 'phone', 'email' => 'email', 'address' => 'address', 'city' => 'city', 'countryCode' => 'country_code', 'timezone' => 'timezone', 'latitude' => 'latitude', 'longitude' => 'longitude', 'workingHours' => 'working_hours_json', 'active' => 'active'];
        $out = [];
        foreach ($map as $k => $v) {
