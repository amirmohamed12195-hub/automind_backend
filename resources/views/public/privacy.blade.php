...
<article class="legal-document">
    ...
    @else
        ...
        <section><h2>2. Information we collect</h2><ul><li>Account details such as name, email, language, country, and an optional phone number if you choose to add one.</li><li>Vehicle details such as make, model, year, VIN, mileage, and maintenance history.</li><li>Diagnostic inputs such as symptom descriptions, photos, audio recordings, and OBD readings.</li><li>Approximate or precise location when you request nearby mechanics and grant permission.</li><li>Operational data such as device and push tokens, IP address, technical logs, and errors.</li><li>Purchase and subscription status supplied by Apple or Google. AutoMind does not receive your payment-card number.</li></ul></section>
